...
department_a = Department.create(account: account1, name: 'Dep A', employees_count: 1, region: 'Pacific')
...
department_b = Department.create(account: account1, name: 'Dep B', employees_count: 1, region: 'Indonesia')
